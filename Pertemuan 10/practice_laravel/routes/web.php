...
Route::get('/mahasiswa/data',[StudentController::class,'data'])->name('student.data');
Route::get('/mahasiswa/data/hapus/{id}',[StudentController::class,'data_destroy'])->name('student.data.destroy');
